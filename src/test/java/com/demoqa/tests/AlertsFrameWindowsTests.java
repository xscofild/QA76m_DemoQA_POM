...
public class AlertsFrameWindowsTests extends TestBase {
    ...
    public void alertWithSelectResultTest() {
        ...
        sidePanel.selectAlerts();
        alerts.clickOnConfirmButton().selectResult("Ok").verifyResult("Ok");
    ...
    public void sendMessageToAlertTest() {
        sidePanel.selectAlerts();
        alerts.clickOnPromptButton().sendMessageToAlert("Hello world !").verifyMessage("Hello world !");
    }

    @Test
    public void switchToNewTabTest() {
        sidePanel.selectWindows();
        new WindowsPage(driver).clickOnNewTabButton().switchToNewTab(1).verifyNewTabTitle("This is a sample page");
